...
Express the volume expansivity and the isothermal compressibility as functions of density $\rho$ and its partial derivatives. For water at $50~\unit{ \degreeCelsius }$ and $1~\unit{ \bar }$, $\kappa = 44.18 \times 10^{-6}$ $\unit{ \bar }$. To what pressure must water be compressed at $50~\unit{ \degreeCelsius }$ to change its density by 1\%? Assume that $\kappa$ is independent of P.
    ...
    \begin{enumerate}[label=(\alph*)]
        \item for $\Delta V$
            \begin{gather*}
                  ...
                  \boxed{ \Delta V = 1.509\times10^{-5}~\unit{ \meter\cubed\per\kilo\gram } } \\
            \end{gather*}
        \item for $W$
            \begin{gather*}
                  W = -P\Delta V \\
      ...
      \begin{center}
          \fbox{%
              \begin{minipage}{0pt}
                  ...
                  \end{align*}
              \end{minipage}%
              \hspace{0pt}% Correct for extra spacing
          }
      \end{center}
\end{solution}
...
\begin{solution}
    ...
    \begin{center}
        \fbox{%
            \begin{minipage}{0pt} % Use \linewidth for flexible width
                \begin{align*}
                    P_{2} &= 
                    \begin{bmatrix}
                        2.19 \\
